...
function clickHandler(event) {
    event.target.className == 'key digit' ? (digit = event.target.innerHTML, document.querySelector('span').append(digit)) : (true);

    event.target.className == 'key operation' ? (operation = event.target.innerHTML, document.querySelector('span').append(operation)) : (true);

    event.target.className == 'key bracket' ? (bracket = event.target.innerHTML, document.querySelector('span').append(bracket)) : (true);

    event.target.className == 'key clear' ? ( document.querySelector('span').innerHTML = '') : (true);

    event.target.className == 'key result' ? (str = document.querySelector('span').innerHTML, result = evaluate(compile(str)), document.querySelector('span').innerHTML = result) : (true);
